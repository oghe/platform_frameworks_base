...
public class NavigationModeController implements Dumpable {
    ...
    private final class MikuSettingsObserver extends ContentObserver {
        public MikuSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private MikuSettingsObserver mMikuSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mMikuSettingsObserver = new MikuSettingsObserver(new Handler());
        mContext.getContentResolver().registerContentObserver(Settings.Secure.getUriFor(
                Settings.Secure.BACK_GESTURE_HEIGHT),
                false, mMikuSettingsObserver, UserHandle.USER_ALL);
